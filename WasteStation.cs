...
class WasteStation 
{
...

	{
		...
		if (trash.GetMaterial() == containerSortType)
		{
			...
			Console.ResetColor();
<<<<<<< HEAD
			pollutionmeter.ChangePollution(-2); // Ved korrekt Sortering gÂr Pollutionmeter % ned.
=======
			pollutionmeter.ChangePollution(-5); // Ved korrekt Sortering gÔøΩr Pollutionmeter % ned.
>>>>>>> 63aaa9bdd5338d8fb54d021d98c9c4b41e59dfac
		...
		else
		{
			...
			Console.ResetColor();
            pollutionmeter.ChangePollution(+5); // Ved forkert  Sortering g√∏r Pollutionmeter % op.
